...
# get and extract hmmer3.1b2 source code
RUN wget http://eddylab.org/software/hmmer/hmmer-3.1b2.tar.gz && tar -xvf hmmer-3.1b2.tar.gz
# get and extract master branch of modification file, copy into hmmer source code
RUN wget -v https://github.com/Larofeticus/hpc_hmmsearch/tarball/master && tar -xvf master && cp /Larofeticus-hpc_hmmsearch-*/hpc_hmmsearch.c /hmmer-3.1b2/src && ls -lh /hmmer-3.1b2/src
